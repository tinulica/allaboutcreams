    ...
    return (
        <footer className="footer footer-2">
                    ...
                    <div className="row">
                        <div className="col-sm-12 col-lg-6">
                            <div className="widget widget-about">
                                <img src={ process.env.PUBLIC_URL + "/assets/images/logo.png" } className="footer-logo" alt="Footer Logo" width="135" height="25" />
                                <p>Articole de machiaj, cosmetică și îngrijire, lifestyle. </p>
                        ...
                        <div className="col-sm-4 col-lg-2">
                            <div className="widget">
                                ...
                                <ul className="widget-list">
                                    <li><Link to={ `${process.env.PUBLIC_URL}/about` }>About AllAboutCreams</Link></li>
                                    <li><Link to={ `${process.env.PUBLIC_URL}/pages/about` }>How to shop on AllAboutCreams</Link></li>
            ...
            <div className="footer-bottom">
                <div className={ container }>
                    <p className="footer-copyright">Copyright © { ( new Date() ).getFullYear() } AllAboutCreams. All Rights Reserved.</p>
