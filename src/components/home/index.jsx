...
// import NewsletterModal from '../features/modal/newsletter-modal'; //newsletter de scos si de la line 117
...
export default function () {
    ...
    return (
        <>
            <Helmet>
                <title>AllAboutCreams</title>
            </Helmet>

            <h1 className="d-none">AllAboutCreams</h1>
